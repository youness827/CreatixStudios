    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="contenu ">
                    <br> <br> <br> <br> <br>
                    <h2 data-aos="fade-down" data-aos-duration="2000">NOUS OFFRONS DES PRESTATIONS DE SERVICE DRONE DE HAUT NIVEAU TANT EN QUALITÉ QU’EN PROFESSIONNALISME AVEC UNE EXPÉRIENCE DE PLUS DE 15 ANS</h2>
                    <br> <br> <br>
                    ...
                    <br> <br> <br> <br>
                    <p data-aos="fade-down" data-aos-duration="2400"> <span class="sp"> Agriculture :</span>Analyse des signes de stress ou de maladies des plantes, Créée des cartes NDVI pour mieux gérer les cultures, Optimisation des ressources d’irrigation, Gestion intelligente des fertilisants, Traitement phytosanitaire smart et précis, Pollinisation artificielle par drone, Distribution des semences et bien d’autres applications !</p>
                    <br>
                    <p data-aos="fade-down" data-aos-duration="2400"> <span class="sp"> Topographie/Photogrammétrie :</span>Levée Topographique, Calcul des stocks/cubatures, Évaluation du volume des travaux, Suivi du chantier, Modélisation 3D/BIM et bien d’autres applications!Effectuer des inspections sûres et efficaces, Inspection massive et précise des unités industrielles : gaz, pétrole, pétrochimie, centrales solaires. Effectuer des inspections d’éoliennes avec une résolution et une précision élevées, Assurer la haute disponibilité des installations industrielles et de production de l’énergie, et bien d’autres applications !</p>
                    <br>
                    <p data-aos="fade-down" data-aos-duration="2400"><span class="sp"> Inspection industrielle :</span> Effectuer des inspections sûres et efficaces, Inspection massive et précise des unités industrielles : gaz, pétrole, pétrochimie, centrales solaires. Effectuer des inspections d’éoliennes avec une résolution et une précision élevées, Assurer la haute disponibilité des installations industrielles et de production de l’énergie, et bien d’autres applications !</p>
                    <br>
                    <p data-aos="fade-down" data-aos-duration="2400"> <span class="sp"> Audio-visuel :</span>Prise de photos 4K, Tournage vidéos en 4K/5K/6K, Tournage aérien avec des caméras professionnelles, Couverture distante des événements avec transmission UHD à la régie et bien d’autres applications </p>
                    <br>
                    <p data-aos="fade-down" data-aos-duration="2400"><span class="sp"> Agriculture :</span> Analyse des signes de stress ou de maladies des plantes, Créée des cartes NDVI pour mieux gérer les cultures, Optimisation des ressources d’irrigation, Gestion intelligente des fertilisants, Traitement phytosanitaire smart et précis, Pollinisation artificielle par drone, Distribution des semences et bien d’autres applications !</p>
