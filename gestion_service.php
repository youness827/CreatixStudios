...
$id_creatix=1;
$typeserviceFR=htmlspecialchars(trim( $_POST["typeserviceFR"]));
$descriptFR=htmlspecialchars(trim( $_POST["descriptFR"]));;
$typeserviceAN=htmlspecialchars(trim( $_POST["typeserviceAN"]));
$descriptAN =htmlspecialchars(trim( $_POST["descriptAN"]));

$stmt=$con->prepare("INSERT into  service 
(ID_CREATIX,TYPE,DESCRIPTION,typeinan,descriptionan) values
(?,?,?,?,?);
   ");
$stmt->execute(array($id_creatix,$typeserviceFR,$descriptFR,$typeserviceAN,$descriptAN));
$count = $stmt->rowCount();
if($count>0){
?>
     <script type="module">
...
<?php
    ...
    $id_service=base64_decode($_GET["idservice"]);
    $typeserviceFRmod = htmlspecialchars(trim($_POST["typeserviceFRmod"])); 
    $descriptFRmod = htmlspecialchars(trim($_POST["descriptFRmod"]));
    $typeserviceANmod = htmlspecialchars(trim($_POST["typeserviceANmod"])); 
    ...
    $stmt=$con->prepare("UPDATE service 
    set  TYPE = ? , DESCRIPTION = ?,typeinan=?,descriptionan=?
    where ID_SERVICE = ?" );
    $stmt->execute(array($typeserviceFRmod,$descriptFRmod,$typeserviceANmod,$descriptANmod,$id_service));
    ...
    $stmt=$con->prepare("DELETE from service 
    where ID_SERVICE = ?" );
...
<?php if(!isset($_GET["listeService"]) && !isset($_GET["editservice"]) ){
?>
<div class="container">
    <div class="row">
        <div class="col">
                            ...
                            <div class="card-body">
                                ...
                                <form action="#" method="post" autocomplete="off" >
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" required placeholder="Nom ( français )"   name="typeserviceFR">
                                    ...
                                    <div class="mb-3">
                                        <div class="inputwithicon"> 
                                        <input autocomplete="off" type="text" class="form-control" required  name="typeserviceAN" placeholder="Nom ( anglais )"  >
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        ...
                                        <a  class="btn btn-outline-success btnbtn"  href="?listeService=true">Liste Des Services </a>
...
<?php } if(isset($_GET["listeService"]) && $_GET["listeService"]=="true" ){  ?> 
                ...
                <div class="card mb-3" style="width:100%">
                    <div class="row g-0">
                        ...
                        <div class="col-md-12">
                            ...
                            <br>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <a  class="btn btn-outline-primary btnbtn"  href="indexAd.php?servicegestion=true&lang=<?php if(isset($_GET["lang"])) echo $_GET["lang"];?>" ><i class="fas fa-plus-circle"></i>&nbsp;&nbsp;nouveau service</a> 
                            ...
                            <div class="table-responsive-xl">
                                ...
                                <table class="table table-bordered  table-hover" style="width: 100%;">
                                        ...
                                        <tbody class="">
                                          ...
                                          $stmt->execute(array());
                                           ...
                                           <td><?= $row["ID_SERVICE"];?></td> 
                                            ...
                                            <a class="btn btn-outline-primary" href="?editservice=true&idservice=<?= urlencode(base64_encode($row["ID_SERVICE"]))?>"><i class="fas fa-edit"></i></a> 
                                                &nbsp;&nbsp;
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <p class="text-muted" style="font-weight:600"> nombres des services  &nbsp;&nbsp; <?= $counts?></p>
                        ...
                        <div class="col-lg-5">
                            <div class="card-body">
                                <div class="contenu">
                                    ...
                                    $stmt->execute(array(base64_decode($_GET["idservice"])));
                                    $rows=$stmt->fetch();
                                    $counts=$stmt->rowCount();
                                    if($counts>0) {
                               ...
                               <form action="#" method="post" autocomplete="off" >
                                    ...
                                    <br><br> <br>
                                    <h2 class="text-center ">Modifier Services</h2>
                                    <br>
                                    <h5 class="text-danger text-center"><?php if(isset($msgs)) echo $msgs;?></h5>
                                    <h5 class="text-left  text-muted">en français</h5>
                                    <div class="mb-3">
                                        <div class="inputwithicon"> 
                                        <input autocomplete="off" type="text" class="form-control"   name="typeserviceFRmod" value="<?= $rows["TYPE"]?>">
                                    ...
                                    <div class="mb-3">
                                        <div class="inputwithicon"> 
                                        <input autocomplete="off" type="text" class="form-control"   name="typeserviceANmod"   value="<?= $rows["typeinan"]?>" placeholder="Nom ( anglais )"  >
                                    ...
                                    <div class="mb-3">
                                        <div class="inputwithicon"> 
                                        <div class="form-floating">
                                        <textarea class="form-control"   name="descriptANmod"   style="height: 100px"><?= $rows["descriptionan"]?></textarea>
                                        </div>
