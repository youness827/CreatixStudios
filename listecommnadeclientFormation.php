...
<?php if (isset($_GET["listecommnadeclientFormation"]) && $_GET["listecommnadeclientFormation"] == "true") {  ?>
                ...
                <div class="loginForm shadow-lg p-3 mb-5 bg-body rounded ">
                    <div class="card mb-3" style="width:100%">
                        <div class="row g-0">
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <h3>Liste des Formation Commander </h3>
                                    <br> <br><br>
                                        ...
                                        <table class="table table-bordered  table-hover" style="width: 100%;">
                                            ...
                                            <thead class="table-dark">
                                                <tr>
                                                    ...
                                                    <th scope="col">Type Formation FR</th>
                                                    <th scope="col">Type Formation AN</th>
                                          ...
                                          commande c , detailformation s , client cl ,formation se,compte co
                                          where c.ID_CLIENT=cl.ID_CLIENT
                                          AND cl.ID_CLIENT = co.ID_CLIENT
                                          AND	s.ID_COMMANDE=c.ID_COMMANDE
                                          AND se.ID_FORMATION=s.ID_FORMATION 
                                         AND  c.date >= ?;
